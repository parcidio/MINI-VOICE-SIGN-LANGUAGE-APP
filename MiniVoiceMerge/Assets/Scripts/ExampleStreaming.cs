...
namespace IBM.Watsson.Examples
{
    public class ExampleStreaming : MonoBehaviour
    {
        ...
        public TMP_InputField ResultsField;
        ...
        void Start()
        {
            ...
            ResultsField.interactable = true;
        ...
        private IEnumerator RecordingHandler()
        {
            ...
            while (_recordingRoutine != 0 && _recording != null)
            {
                ...
                if (writePos > _recording.samples || !Microphone.IsRecording(_microphoneID))
                {
                    ...
                    Toast.Instance.Show("Unable to start the microphone", .5f, Toast.ToastColor.Green);
            ...
            if (result != null && result.results.Length > 0)
            {
                foreach (var res in result.results)
                {
                    foreach (var alt in res.alternatives)
                    {
                        ...
                        string transcribe = alt.transcript;
                        TempString = " " + transcribe;
                        if (res.final) { 
                            
                            ResultsField.text += TempString.Replace("%HESITATION", "");
                        }

                        Log.Debug("TESTING: ", TempString);
